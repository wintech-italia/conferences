...
uses
  REST.Methods.Server, Web.WebReq;

procedure TWebModule1.DSServerClass1GetClass(
  DSServerClass: TDSServerClass; var PersistentClass: TPersistentClass);
begin
  PersistentClass := REST.Methods.Server.TServerMethods1;
end;
...
begin
  if SameText(TagString, 'urlpath') then
    ...
    ReplaceText := REST.Methods.Server.TServerMethods1.ClassName
